...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recipe1.setImageResource(R.drawable.food_nabe);
        //ボタンが押されたときの動作
        ...
        recipe2.setImageResource(R.drawable.food_syougayaki);
        //ボタンが押されたときの動作
        recipe2.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Intent intent = new Intent(MainActivity2.this,recipe2.class);
                int viewData = 2; //レシピ画面において表示する画像の番号
                intent.putExtra("POSITION", viewData);
                intent.putExtra("FOOD_IMAGE", R.drawable.food_syougayaki);
                startActivity(intent);
            }
        });
        ...
        recipe3.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Intent intent = new Intent(MainActivity2.this,recipe3.class);
